...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    /**
     * 将 字符串 转换成 对应值类型 支持:（String/Long/Integer/Date/Double/Float/Map/List/Class）
     * @param str 字符串值
     * @param clazz 值类型
     * @return
     */
    public static Object toObject(String str, Class<?> clazz){
    	...
    	}else if(Map.class.equals(clazz) || HashMap.class.equals(clazz)){
	...
	public static List<Object> jsonStrToList(String jsonStr) {
  	...
  	public static void main(String[] args) {
		...
		List<Object> list2 = jsonStrToList(str);
